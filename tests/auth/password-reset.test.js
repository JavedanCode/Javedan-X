...
describe('POST /auth/password/reset', () => {
  ...
  it.skipIf(!env.EMAIL_ENABLED)('resets the password with a valid token', async () => {
  ...
  it.skipIf(!env.EMAIL_ENABLED)('allows the user to log in with the new password', async () => {
    const token = await createResetToken();
  ...
  it.skipIf(!env.EMAIL_ENABLED)('rejects the old password after the reset', async () => {
    const token = await createResetToken();
