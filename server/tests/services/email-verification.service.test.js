...
describe('email verification service', () => {
  ...
  it.skipIf(!env.EMAIL_ENABLED)('sends an email verification email', async () => {
  ...
  it.skipIf(!env.EMAIL_ENABLED)(
    'sends a new verification email when resending is allowed',
    async () => {
  ...
  it.skipIf(!env.EMAIL_ENABLED)(
    'does not send another email during the cooldown period',
    async () => {
      await resendEmailVerification(user.email);
